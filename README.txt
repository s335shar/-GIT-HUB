----------------------------------------------
Jira 8.6.0-#806000 README
----------------------------------------------

Thank you for downloading Jira 8.6.0. This distribution comes with a
...
Full documentation:
http://docs.atlassian.com/jira/jadm-docs-086/Installing+Jira+applications
...
2. Set the JAVA_HOME variable to where you installed Java.
   ...
   http://docs.atlassian.com/jira/jadm-docs-086/Installing+Java

3. Set your Jira home directory.

   See the following instructions for details:
   http://docs.atlassian.com/jira/jadm-docs-086/Setting+your+Jira+application+home+directory
...
Full documentation:
http://docs.atlassian.com/jira/jadm-docs-086/Upgrading+Jira+applications
...
-  Complete the pre-upgrade steps that include running a Jira health check,
   ...
   See the following instructions for details:
   http://docs.atlassian.com/jira/jadm-docs-086/Preparing+for+the+upgrade
...
3. If you're using an Oracle or MySQL database, download the database driver
   ...
   Supported drivers:
   http://docs.atlassian.com/jira/jadm-docs-086/Supported+platforms
...
Try the docs at:
http://docs.atlassian.com/jira/jadm-docs-086/
